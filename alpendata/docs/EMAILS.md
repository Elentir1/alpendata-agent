...
La recherche des copies envoyées est testée avec HTTP synthétique : droits personnels, restrictions d’entreprise, marqueurs et destinataires incorrects, absence, copie trouvée, anciennes tentatives et erreurs Graph. Le navigateur teste aussi une réponse de vérification perdue et le rechargement du reçu. La résolution opérateur des résultats toujours incertains reste à réaliser ; aucune relance n’est activée par l’absence de copie. L’enregistrement de brouillons Outlook, les réponses attachées aux fils et l’autonomie personnelle configurable restent également à implémenter. Aucun envoi vers une boîte réelle n’a été effectué lors de cette validation. Les essais Entra/Exchange et fournisseur IA réels restent nécessaires avant le pilote.
