...
export function Chat({ organizationId, licensed, language, t, initialConversationId = '', onManage, navigation, companyName }: { navigation?: ReactNode; companyName?: string; onManage?: () => void; initialConversationId?: string; organizationId: string; licensed: boolean; language: Language; t: Text }) {
