...
const text = {
  fr: {
    ...
    sendMail: 'Envoyer mes mails', sendMailDetail: 'Envoyer depuis mon compte selon mon choix de confirmation.', write: 'Enregistrer mes documents', writeDetail: 'Déposer un document dans un dossier Microsoft 365 après votre confirmation.',
    ...
    permission: 'Connectez votre propre compte Microsoft. Cette connexion reste personnelle. Selon les règles de votre entreprise, une validation de votre administrateur Microsoft peut être nécessaire.',
  ...
  en: {
    ...
    sendMail: 'Send my email', sendMailDetail: 'Send from my account according to my confirmation choice.', write: 'Save my documents', writeDetail: 'Save a document to a Microsoft 365 folder after your confirmation.',
    ...
    permission: 'Connect your own Microsoft account. This connection stays personal. Your company’s policies may require approval from your Microsoft administrator.',
