...
export const copy = {
  fr: {
    ...
    saved: 'Vos réponses sont enregistrées.', nextTitle: 'Passons à votre premier résultat.',
    nextText: 'Retrouvez votre besoin ci-dessous et affinez-le si nécessaire. Vous pouvez aussi connecter vos outils pour travailler avec vos e-mails et vos documents.',
  ...
  en: {
    ...
    saved: 'Your answers have been saved.', nextTitle: 'Let’s get your first result.',
    nextText: 'Your goal is ready below. Refine it if needed, or connect your tools to work with your emails and documents.',
