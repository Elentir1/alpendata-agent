export interface CompanyResource {
  created_by: string; can_manage: boolean;
...
export interface ResourceMember { user_id: string; display_name: string; role: 'admin' | 'member'; active: boolean }
...
export const resourceWords = {
  fr: {
    ...
    admin: 'L’auteur et les administrateurs peuvent consulter et gérer cette copie. Choisissez les autres collaborateurs qui pourront la lire avec leur assistant.',
    personalCopy: 'Vous pouvez gérer les copies que vous publiez. Les destinataires peuvent les consulter ; vos fichiers et conversations d’origine restent privés.',
    source: 'Copie du document créé dans votre chat', shared: 'La copie est partagée dans les ressources de l’entreprise.', share: 'Partager dans l’entreprise',
    ...
    audience: 'Qui peut consulter cette copie ?', team: 'Toute l’équipe, y compris les futurs collaborateurs', selected: 'Certains collaborateurs', onlyAdmins: 'Sans destinataire sélectionné, seuls l’auteur et les administrateurs y auront accès.',
  ...
  en: {
    ...
    admin: 'The author and administrators can read and manage this copy. Choose which other colleagues can read it with their assistant.',
    personalCopy: 'You can manage the copies you publish. Recipients can read them; your original files and conversations remain private.',
    source: 'Copy of the document created in your chat', shared: 'The copy is shared in company resources.', share: 'Share with the company',
    ...
    audience: 'Who can read this copy?', team: 'The whole team, including future colleagues', selected: 'Selected colleagues', onlyAdmins: 'With no recipients selected, only the author and administrators will have access.',
