            ...
            with self.factory.begin() as db:
                ...
                if at - due <= CATCH_UP_SECONDS:
                    ...
                    conversation = Conversation(
                        ...
                        integration_provider=template.integration_provider,
                        project_id=template.project_id,
                        context_project_id=template.context_project_id,
                        work_settings=template.work_settings,
                        service_features=template.service_features,
